<%@ Page Language="C#" MasterPageFile="~/Nav.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="AppFactory.Default" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
        <div class="Welcome">
          <div class="Message"><h1>Welcome To AppFactory</h1> <hr style="margin:0.5em;" /> <p>This is a great opportunity for graduates to invest 
