<%@ Page Language="C#" MasterPageFile="~/Nav.Master" AutoEventWireup="true" CodeBehind="Manager.aspx.cs" Inherits="AppFactory.Manager" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
             <div class="Interns"> 
         <h1 style="color:#4FC3F7;padding:0">Mentors Information</h1>
    <asp:Table  ID="Managers" runat="server" Width="100%"> 
